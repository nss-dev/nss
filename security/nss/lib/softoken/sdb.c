...
struct SDBPrivateStr {
    ...
    sqlite3 *sqlXactDB;		/* access protected by lock, use protected
                                 * by the transaction. Current transaction db*/
    PRThread *sqlXactThread;	/* protected by lock,
			         * current transaction thread */
    sqlite3 *sqlReadDB;		/* use protected by lock, value invariant */
    ...
    PRMonitor *dbMon;		/* invariant, lock to protect sqlXact* fields*/
};
