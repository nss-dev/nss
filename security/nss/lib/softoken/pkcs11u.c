...
sftk_FindTokenAttribute(SFTKTokenObject *object,CK_ATTRIBUTE_TYPE type)
{
    ...
    dbHandle = sftk_getDBForObject(object->obj.slot, object->obj.handle);
						...
						void *value, unsigned int len)
{
    ...
    dbHandle = sftk_getDBForObject(object->slot, object->handle);
...
sftk_DeleteObject(SFTKSession *session, SFTKObject *object)
{
  ...
  /* Handle Token case */
	...
	SFTKDBHandle *handle = sftk_getDBForObject(slot, object->handle);
