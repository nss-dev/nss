...
ifndef NS_USE_GCC
	...
	ifeq ($(OS_TEST), ia64)
	    ...
	    HPUX_OS_CFLAGS	+= +DAportable +DS2.0
	    else
	    HPUX_OS_CFLAGS	+= -Aa +e +DA2.0W +DS2.0 +DChpux
	    endif
	endif
    else
	ifeq ($(OS_TEST), ia64)
	    HPUX_OS_CFLAGS	+= -Aa +e +p +DD32
	else
	    HPUX_OS_CFLAGS	+= +DAportable +DS2.0
	endif
    endif
...
OS_CFLAGS += $(HPUX_OS_CFLAGS) -DHPUX11
