...
const Constant _consts[] = {
    ...
    mkEntry(CKF_ERROR_STATE, TokenFlags),
    mkEntry(CKF_SEED_RANDOM_REQUIRED, TokenFlags),
    mkEntry(CKF_ASYNC_SESSION_SUPPORTED, TokenFlags),

    mkEntry(CKF_RW_SESSION, SessionFlags),
    mkEntry(CKF_SERIAL_SESSION, SessionFlags),
    mkEntry(CKF_ASYNC_SESSION, SessionFlags),

    mkEntry(CKF_HW, MechanismFlags),
    mkEntry(CKF_MESSAGE_ENCRYPT, MechanismFlags),
    mkEntry(CKF_MESSAGE_DECRYPT, MechanismFlags),
    mkEntry(CKF_MESSAGE_SIGN, MechanismFlags),
    mkEntry(CKF_MESSAGE_VERIFY, MechanismFlags),
    mkEntry(CKF_MULTI_MESSAGE, MechanismFlags),
    mkEntry(CKF_FIND_OBJECTS, MechanismFlags),
    ...
    mkEntry(CKF_DECAPSULATE, MechanismFlags),
    mkEntry(CKF_ENCAPSULATE, MechanismFlags),
    mkEntry(CKF_EXTENSION, MechanismFlags),
    ...
    mkEntry(CKU_CONTEXT_SPECIFIC, Users),
    ...
    mkEntry(CKO_MECHANISM, Object),
    mkEntry(CKO_OTP_KEY, Object),
    mkEntry(CKO_PROFILE, Object),
    mkEntry(CKO_TRUST, Object),
    mkEntry(CKO_VALIDATION, Object),
    ...
    mkEntry(CKH_USER_INTERFACE, Hardware),
    ...
    mkEntry(CKK_BLOWFISH, KeyType),
    mkEntry(CKK_TWOFISH, KeyType),
    mkEntry(CKK_SECURID, KeyType),
    mkEntry(CKK_ACTI, KeyType),
    mkEntry(CKK_HOTP, KeyType),
    mkEntry(CKK_CAMELLIA, KeyType),
    mkEntry(CKK_SEED, KeyType),
    mkEntry(CKK_ARIA, KeyType),
    mkEntry(CKK_MD5_HMAC, KeyType),
    mkEntry(CKK_SHA_1_HMAC, KeyType),
    mkEntry(CKK_RIPEMD128_HMAC, KeyType),
    mkEntry(CKK_RIPEMD160_HMAC, KeyType),
    mkEntry(CKK_SHA256_HMAC, KeyType),
    mkEntry(CKK_SHA384_HMAC, KeyType),
    mkEntry(CKK_SHA512_HMAC, KeyType),
    mkEntry(CKK_SHA224_HMAC, KeyType),
    mkEntry(CKK_GOSTR3410, KeyType),
    mkEntry(CKK_GOSTR3411, KeyType),
    mkEntry(CKK_GOST28147, KeyType),
    mkEntry(CKK_CHACHA20, KeyType),
    mkEntry(CKK_POLY1305, KeyType),
    mkEntry(CKK_AES_XTS, KeyType),
    mkEntry(CKK_SHA3_224_HMAC, KeyType),
    mkEntry(CKK_SHA3_256_HMAC, KeyType),
    mkEntry(CKK_SHA3_384_HMAC, KeyType),
    mkEntry(CKK_SHA3_512_HMAC, KeyType),
    mkEntry(CKK_BLAKE2B_160_HMAC, KeyType),
    mkEntry(CKK_BLAKE2B_256_HMAC, KeyType),
    mkEntry(CKK_BLAKE2B_384_HMAC, KeyType),
    mkEntry(CKK_BLAKE2B_512_HMAC, KeyType),
    mkEntry(CKK_SALSA20, KeyType),
    mkEntry(CKK_X2RATCHET, KeyType),
    mkEntry(CKK_EC_EDWARDS, KeyType),
    mkEntry(CKK_EC_MONTGOMERY, KeyType),
    mkEntry(CKK_HKDF, KeyType),
    mkEntry(CKK_SHA512_224_HMAC, KeyType),
    mkEntry(CKK_SHA512_256_HMAC, KeyType),
    mkEntry(CKK_SHA512_T_HMAC, KeyType),
    mkEntry(CKK_HSS, KeyType),
    mkEntry(CKK_ML_DSA, KeyType),
    mkEntry(CKK_ML_KEM, KeyType),
    mkEntry(CKK_SLH_DSA, KeyType),
    mkEntry(CKK_XMSS, KeyType),
    mkEntry(CKK_XMSSMT, KeyType),
    mkEntry(CKK_NSS_PKCS8, KeyType),

    mkEntry(CKC_X_509, CertType),
    mkEntry(CKC_X_509_ATTR_CERT, CertType),
    mkEntry(CKC_WTLS, CertType),

    mkEntry(CK_CERTIFICATE_CATEGORY_UNSPECIFIED, CertCategory),
    mkEntry(CK_CERTIFICATE_CATEGORY_TOKEN_USER, CertCategory),
    mkEntry(CK_CERTIFICATE_CATEGORY_AUTHORITY, CertCategory),
    mkEntry(CK_CERTIFICATE_CATEGORY_OTHER_ENTITY, CertCategory),

    mkEntry(CK_SECURITY_DOMAIN_UNSPECIFIED, SecurityDomain),
    mkEntry(CK_SECURITY_DOMAIN_MANUFACTURER, SecurityDomain),
    mkEntry(CK_SECURITY_DOMAIN_OPERATOR, SecurityDomain),
    mkEntry(CK_SECURITY_DOMAIN_THIRD_PARTY, SecurityDomain),

    mkEntry(CK_OTP_FORMAT_DECIMAL, OTPFormat),
    mkEntry(CK_OTP_FORMAT_HEXADECIMAL, OTPFormat),
    mkEntry(CK_OTP_FORMAT_ALPHANUMERIC, OTPFormat),
    mkEntry(CK_OTP_FORMAT_BINARY, OTPFormat),

    mkEntry(CK_OTP_PARAM_IGNORED, OTPParam),
    mkEntry(CK_OTP_PARAM_OPTIONAL, OTPParam),
    mkEntry(CK_OTP_PARAM_MANDATORY, OTPParam),
    ...
    mkEntry2(CKA_UNIQUE_ID, Attribute, None),
    ...
    mkEntry2(CKA_CERTIFICATE_CATEGORY, Attribute, CertCategory),
    mkEntry2(CKA_JAVA_MIDP_SECURITY_DOMAIN, Attribute, SecurityDomain),
    mkEntry2(CKA_URL, Attribute, None),
    mkEntry2(CKA_HASH_OF_SUBJECT_PUBLIC_KEY, Attribute, None),
    mkEntry2(CKA_HASH_OF_ISSUER_PUBLIC_KEY, Attribute, None),
    mkEntry2(CKA_NAME_HASH_ALGORITHM, Attribute, Mechanism),
    mkEntry2(CKA_CHECK_VALUE, Attribute, None),
    ...
    mkEntry2(CKA_PUBLIC_KEY_INFO, Attribute, None),
    ...
    mkEntry2(CKA_SUBPRIME_BITS, Attribute, None),
    ...
    mkEntry2(CKA_COPYABLE, Attribute, Bool),
    mkEntry2(CKA_DESTROYABLE, Attribute, Bool),
    ...
    mkEntry2(CKA_ALWAYS_AUTHENTICATE, Attribute, Bool),
    mkEntry2(CKA_WRAP_WITH_TRUSTED, Attribute, Bool),
    mkEntry2(CKA_WRAP_TEMPLATE, Attribute, None),
    mkEntry2(CKA_UNWRAP_TEMPLATE, Attribute, None),
    mkEntry2(CKA_DERIVE_TEMPLATE, Attribute, None),
    mkEntry2(CKA_OTP_FORMAT, Attribute, OTPFormat),
    mkEntry2(CKA_OTP_LENGTH, Attribute, None),
    mkEntry2(CKA_OTP_TIME_INTERVAL, Attribute, None),
    mkEntry2(CKA_OTP_USER_FRIENDLY_MODE, Attribute, None),
    mkEntry2(CKA_OTP_CHALLENGE_REQUIREMENT, Attribute, OTPParam),
    mkEntry2(CKA_OTP_TIME_REQUIREMENT, Attribute, OTPParam),
    mkEntry2(CKA_OTP_COUNTER_REQUIREMENT, Attribute, OTPParam),
    mkEntry2(CKA_OTP_PIN_REQUIREMENT, Attribute, OTPParam),
    mkEntry2(CKA_OTP_COUNTER, Attribute, None),
    mkEntry2(CKA_OTP_TIME, Attribute, None),
    mkEntry2(CKA_OTP_USER_IDENTIFIER, Attribute, None),
    mkEntry2(CKA_OTP_SERVICE_IDENTIFIER, Attribute, None),
    mkEntry2(CKA_OTP_SERVICE_LOGO, Attribute, None),
    mkEntry2(CKA_OTP_SERVICE_LOGO_TYPE, Attribute, None),
    mkEntry2(CKA_GOSTR3410_PARAMS, Attribute, None),
    mkEntry2(CKA_GOSTR3411_PARAMS, Attribute, None),
    mkEntry2(CKA_GOST28147_PARAMS, Attribute, None),
    ...
    mkEntry2(CKA_PIXEL_X, Attribute, None),
    mkEntry2(CKA_PIXEL_Y, Attribute, None),
    mkEntry2(CKA_RESOLUTION, Attribute, None),
    mkEntry2(CKA_CHAR_ROWS, Attribute, None),
    mkEntry2(CKA_CHAR_COLUMNS, Attribute, None),
    mkEntry2(CKA_COLOR, Attribute, None),
    mkEntry2(CKA_BITS_PER_PIXEL, Attribute, None),
    mkEntry2(CKA_CHAR_SETS, Attribute, None),
    mkEntry2(CKA_ENCODING_METHODS, Attribute, None),
    mkEntry2(CKA_MIME_TYPES, Attribute, None),
    mkEntry2(CKA_MECHANISM_TYPE, Attribute, Mechanism),
    mkEntry2(CKA_REQUIRED_CMS_ATTRIBUTES, Attribute, None),
    mkEntry2(CKA_DEFAULT_CMS_ATTRIBUTES, Attribute, None),
    mkEntry2(CKA_SUPPORTED_CMS_ATTRIBUTES, Attribute, None),
    mkEntry2(CKA_PROFILE_ID, Attribute, None),
    mkEntry2(CKA_X2RATCHET_BAG, Attribute, None),
    mkEntry2(CKA_X2RATCHET_BAGSIZE, Attribute, None),
    mkEntry2(CKA_X2RATCHET_BOBS1STMSG, Attribute, None),
    mkEntry2(CKA_X2RATCHET_CKR, Attribute, None),
    mkEntry2(CKA_X2RATCHET_CKS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_DHP, Attribute, None),
    mkEntry2(CKA_X2RATCHET_DHR, Attribute, None),
    mkEntry2(CKA_X2RATCHET_DHS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_HKR, Attribute, None),
    mkEntry2(CKA_X2RATCHET_HKS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_ISALICE, Attribute, None),
    mkEntry2(CKA_X2RATCHET_NHKR, Attribute, None),
    mkEntry2(CKA_X2RATCHET_NHKS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_NR, Attribute, None),
    mkEntry2(CKA_X2RATCHET_NS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_PNS, Attribute, None),
    mkEntry2(CKA_X2RATCHET_RK, Attribute, None),
    mkEntry2(CKA_HSS_LEVELS, Attribute, None),
    mkEntry2(CKA_HSS_LMS_TYPE, Attribute, None),
    mkEntry2(CKA_HSS_LMOTS_TYPE, Attribute, None),
    mkEntry2(CKA_HSS_LMS_TYPES, Attribute, None),
    mkEntry2(CKA_HSS_LMOTS_TYPES, Attribute, None),
    mkEntry2(CKA_HSS_KEYS_REMAINING, Attribute, None),
    mkEntry2(CKA_PARAMETER_SET, Attribute, None),
    mkEntry2(CKA_OBJECT_VALIDATION_FLAGS, Attribute, None),
    mkEntry2(CKA_VALIDATION_TYPE, Attribute, None),
    mkEntry2(CKA_VALIDATION_VERSION, Attribute, None),
    mkEntry2(CKA_VALIDATION_LEVEL, Attribute, None),
    mkEntry2(CKA_VALIDATION_MODULE_ID, Attribute, None),
    mkEntry2(CKA_VALIDATION_FLAG, Attribute, None),
    mkEntry2(CKA_VALIDATION_AUTHORITY_TYPE, Attribute, None),
    mkEntry2(CKA_VALIDATION_COUNTRY, Attribute, None),
    mkEntry2(CKA_VALIDATION_CERTIFICATE_IDENTIFIER, Attribute, None),
    mkEntry2(CKA_VALIDATION_CERTIFICATE_URI, Attribute, None),
    mkEntry2(CKA_VALIDATION_PROFILE, Attribute, None),
    mkEntry2(CKA_VALIDATION_VENDOR_URI, Attribute, None),
    mkEntry2(CKA_ENCAPSULATE_TEMPLATE, Attribute, None),
    mkEntry2(CKA_DECAPSULATE_TEMPLATE, Attribute, None),
    mkEntry2(CKA_PKCS_TRUST_SERVER_AUTH, Attribute, Trust),
    mkEntry2(CKA_PKCS_TRUST_CLIENT_AUTH, Attribute, Trust),
    mkEntry2(CKA_PKCS_TRUST_CODE_SIGNING, Attribute, Trust),
    mkEntry2(CKA_PKCS_TRUST_EMAIL_PROTECTION, Attribute, Trust),
    mkEntry2(CKA_TRUST_IPSEC_IKE, Attribute, Trust),
    mkEntry2(CKA_PKCS_TRUST_TIME_STAMPING, Attribute, Trust),
    mkEntry2(CKA_PKCS_TRUST_OCSP_SIGNING, Attribute, Trust),
    mkEntry2(CKA_ENCAPSULATE, Attribute, Bool),
    mkEntry2(CKA_DECAPSULATE, Attribute, Bool),
    mkEntry2(CKA_HASH_OF_CERTIFICATE, Attribute, None),
    mkEntry2(CKA_PUBLIC_CRC64_VALUE, Attribute, None),
    mkEntry2(CKA_SEED, Attribute, None),
    ...
    mkEntry2(CKA_NSS_TRUST_DIGITAL_SIGNATURE, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_NON_REPUDIATION, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_KEY_ENCIPHERMENT, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_DATA_ENCIPHERMENT, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_KEY_AGREEMENT, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_KEY_CERT_SIGN, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_CRL_SIGN, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_SERVER_AUTH, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_CLIENT_AUTH, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_CODE_SIGNING, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_EMAIL_PROTECTION, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_IPSEC_END_SYSTEM, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_IPSEC_TUNNEL, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_IPSEC_USER, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_TIME_STAMPING, Attribute, Trust),
    mkEntry2(CKA_NSS_TRUST_STEP_UP_APPROVED, Attribute, Bool),
    mkEntry2(CKA_NSS_CERT_SHA1_HASH, Attribute, None),
    mkEntry2(CKA_NSS_CERT_MD5_HASH, Attribute, None),
    ...
    mkEntry(CKT_TRUSTED, Trust),
    mkEntry(CKT_TRUST_ANCHOR, Trust),
    mkEntry(CKT_NOT_TRUSTED, Trust),
    mkEntry(CKT_TRUST_MUST_VERIFY_TRUST, Trust),
    mkEntry(CKT_TRUST_UNKNOWN, Trust),
