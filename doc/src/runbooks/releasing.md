(mozilla-projects-nss-runbooks-releasing)=
...
- Normal development. This runs from the day after a Firefox merge until 2 weeks before the next Firefox merge. During this time, the version of NSS in mozilla-central and on NSS's development branch are kept in sync by [Updatebot](https://github.com/mozilla-services/updatebot).
...
2. Announce the release on [dev-tech-crypto](https://groups.google.com/a/mozilla.org/g/dev-tech-crypto).

## Preparing for the next release

> 1. File a new bug blocking the [nss-uplift bug](https://bugzilla.mozilla.org/show_bug.cgi?id=nss-uplift) by cloning the current release bug.
