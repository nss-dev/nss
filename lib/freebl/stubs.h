...
#define MPR_Assert PR_Assert_stub
#define MPR_Access PR_Access_stub
#define MPR_CallOnce PR_CallOnce_stub
#define MPR_Close PR_Close_stub
#define MPR_DestroyCondVar PR_DestroyCondVar_stub
#define MPR_DestroyLock PR_DestroyLock_stub
#define MPR_Free PR_Free_stub
#define MPR_GetLibraryFilePathname PR_GetLibraryFilePathname_stub
#define MPR_ImportPipe PR_ImportPipe_stub
#define MPR_Lock PR_Lock_stub
#define MPR_NewCondVar PR_NewCondVar_stub
#define MPR_NewLock PR_NewLock_stub
#define MPR_NotifyCondVar PR_NotifyCondVar_stub
#define MPR_NotifyAllCondVar PR_NotifyAllCondVar_stub
#define MPR_Open PR_Open_stub
#define MPR_Read PR_Read_stub
#define MPR_Seek PR_Seek_stub
#define MPR_Sleep PR_Sleep_stub
#define MPR_Unlock PR_Unlock_stub
#define MPR_WaitCondVar PR_WaitCondVar_stub
#define MPR_GetEnvSecure PR_GetEnvSecure_stub
