...
SECStatus tls13_ClientHandleEarlyDataXtn(const sslSocket *ss, TLSExtensionData *xtnData, PRUint16 ex_type,
                                         SECItem *data);
SECStatus tls13_ServerSendEarlyDataXtn(const sslSocket *ss, TLSExtensionData *xtnData,
                                       PRBool append,
                                       PRUint32 maxBytes);
...
SECStatus tls13_ClientHandleSigAlgsXtn(const sslSocket *ss, TLSExtensionData *xtnData, PRUint16 ex_type,
                                       SECItem *data);
SECStatus tls13_ServerSendSigAlgsXtn(const sslSocket *ss, TLSExtensionData *xtnData,
                                     PRBool append,
                                     PRUint32 maxBytes);
