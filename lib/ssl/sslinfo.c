...
static const SSLCipherSuiteInfo suiteInfo[] = {
    ...
    {0,CS(TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384), S_ECDSA, K_ECDHE, C_AESGCM, B_256, M_SHA384, 1, 0, 0 },
    {0,CS(TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256), S_RSA, K_ECDHE, C_AESGCM, B_128, M_SHA256, 1, 0, 0 },
    {0,CS(TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384), S_RSA, K_ECDHE, C_AESGCM, B_128, M_SHA384, 1, 0, 0 },
