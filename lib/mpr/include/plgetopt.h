 ...
 */
PR_EXTERN(PLOptState*) MPL_CreateOptState(
    PRIntn argc, char **argv, const char *options);

/*
 * MPL_CreateLongOptState
 *
 * Alternative to MPL_CreateOptState.
 ...
 */
PR_EXTERN(PLOptState*) MPL_CreateLongOptState(
    PRIntn argc, char **argv, const char *options,
    const PLLongOpt *longOpts);
/*
 * MPL_DestroyOptState
 *
 * Call this to destroy the PLOptState returned from MPL_CreateOptState or
 * MPL_CreateLongOptState.
 */
PR_EXTERN(void) MPL_DestroyOptState(PLOptState *opt);
 ...
 */
PR_EXTERN(PLOptStatus) MPL_GetNextOpt(PLOptState *opt);
