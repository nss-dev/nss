...
*/
NSPR_API(PRIntn) MPR_CeilingLog2(PRUint32 i);

/*
** Compute the log of the greatest power of 2 less than or equal to n
*/
NSPR_API(PRIntn) MPR_FloorLog2(PRUint32 i);

/*
** Macro version of MPR_CeilingLog2: Compute the log of the least power of
...
/*
** Macro version of MPR_FloorLog2: Compute the log of the greatest power of
