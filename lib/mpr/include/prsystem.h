...
NSPR_API(char) MPR_GetDirectorySeparator(void);

/*
** OBSOLETE -- the function name is misspelled.
** Use MPR_GetDirectorySeparator instead.
*/

NSPR_API(char) MPR_GetDirectorySepartor(void);
...
NSPR_API(char) MPR_GetPathSeparator(void);

/* Types of information available via MPR_GetSystemInfo(...) */
typedef enum {
...
** the failure can be retrieved from MPR_GetError().
**
...
NSPR_API(PRStatus) MPR_GetSystemInfo(PRSysInfo cmd, char *buf, PRUint32 buflen);

/*
** Return the number of bytes in a page
*/
NSPR_API(PRInt32) MPR_GetPageSize(void);

/*
** Return log2 of the size of a page
*/
NSPR_API(PRInt32) MPR_GetPageShift(void);

/*
** MPR_GetNumberOfProcessors() -- returns the number of CPUs
**
** Description:
** MPR_GetNumberOfProcessors() extracts the number of processors
...
**
*/
NSPR_API(PRInt32) MPR_GetNumberOfProcessors( void );

/*
** MPR_GetPhysicalMemorySize() -- returns the amount of system RAM
**
** Description:
** MPR_GetPhysicalMemorySize() determines the amount of physical RAM
...
**
*/
NSPR_API(PRUint64) MPR_GetPhysicalMemorySize(void);
