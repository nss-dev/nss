...
**      initializer
***********************************************************************/
NSPR_API(PRInt64) MLL_MaxInt(void);
NSPR_API(PRInt64) MLL_MinInt(void);
NSPR_API(PRInt64) MLL_Zero(void);
NSPR_API(PRUint64) MLL_MaxUint(void);
...
#define LL_MAXINT   MLL_MaxInt()
#define LL_MININT   MLL_MinInt()
#define LL_ZERO     MLL_Zero()
#define LL_MAXUINT  MLL_MaxUint()
