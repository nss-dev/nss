...
*/
NSPR_API(PRSemaphore*) MPR_NewSem(PRUintn value);

/*
** Destroy the given semaphore object.
**
*/
NSPR_API(void) MPR_DestroySem(PRSemaphore *sem);
...
*/
NSPR_API(PRStatus) MPR_WaitSem(PRSemaphore *sem);
...
*/
NSPR_API(void) MPR_PostSem(PRSemaphore *sem);
