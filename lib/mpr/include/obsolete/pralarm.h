...
** ALGORITHM:   N/A
***********************************************************************/
NSPR_API(PRAlarm*) MPR_CreateAlarm(void);

/***********************************************************************
** FUNCTION:    MPR_DestroyAlarm
** DESCRIPTION:
**  Destroys the context created by MPR_CreateAlarm().
** INPUTS:      PRAlarm*
** OUTPUTS:     None
** RETURN:      PRStatus
**
** SIDE EFFECTS:
**  This destroys the context that was created by MPR_CreateAlarm().
...
** ALGORITHM:   N/A
***********************************************************************/
NSPR_API(PRStatus) MPR_DestroyAlarm(PRAlarm *alarm);

/***********************************************************************
** FUNCTION:    MPR_SetAlarm
** DESCRIPTION:
...
**  context is destroyed (MPR_DestroyAlarm).
** RESTRICTIONS:
**  None.
...
** MEMORY:      N/A.
** ALGORITHM:   See MPR_SetAlarm().
***********************************************************************/
NSPR_API(PRStatus) MPR_ResetAlarm(
