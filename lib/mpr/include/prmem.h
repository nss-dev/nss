...
/*
** MPR_Malloc, MPR_Calloc, MPR_Realloc, and MPR_Free have the same signatures
...
** by PRUint32.)  Memory allocated by MPR_Malloc, MPR_Calloc, or MPR_Realloc
** must be freed by MPR_Free.
*/

NSPR_API(void *) MPR_Malloc(PRUint32 size);

NSPR_API(void *) MPR_Calloc(PRUint32 nelem, PRUint32 elsize);

NSPR_API(void *) MPR_Realloc(void *ptr, PRUint32 size);

NSPR_API(void) MPR_Free(void *ptr);

/*
** The following are some convenience macros defined in terms of
** MPR_Malloc, MPR_Calloc, MPR_Realloc, and MPR_Free.
*/
...
***********************************************************************/
#define PR_MALLOC(_bytes) (MPR_Malloc((_bytes)))
...
***********************************************************************/
#define PR_REALLOC(_ptr, _size) (MPR_Realloc((_ptr), (_size)))
...
** RETURN:  pointer to node allocated
***********************************************************************/
#define PR_CALLOC(_size) (MPR_Calloc(1, (_size)))
...
***********************************************************************/
#define PR_NEWZAP(_struct) ((_struct*)MPR_Calloc(1, sizeof(_struct)))
...
** RETURN:  void
***********************************************************************/
#define PR_DELETE(_ptr) { MPR_Free(_ptr); (_ptr) = NULL; }
