...
/*
** MPR_strtod() returns as a double-precision floating-point number
...
*/
NSPR_API(PRFloat64)
MPR_strtod(const char *s00, char **se);
...
** point value.
*/
NSPR_API(void) MPR_cnvtf(char *buf, PRIntn bufsz, PRIntn prcsn, PRFloat64 fval);

/*
** MPR_dtoa() converts double to a string.
**
** ARGUMENTS:
...
*/
NSPR_API(PRStatus) MPR_dtoa(PRFloat64 d, PRIntn mode, PRIntn ndigits,
