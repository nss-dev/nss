...
*/
NSPR_API(PRInt32)   MPR_AtomicIncrement(PRInt32 *val);

/*
** FUNCTION: MPR_AtomicDecrement
** DESCRIPTION:
...
*/
NSPR_API(PRInt32)   MPR_AtomicDecrement(PRInt32 *val);

/*
** FUNCTION: MPR_AtomicSet
** DESCRIPTION:
...
*/
NSPR_API(PRInt32) MPR_AtomicSet(PRInt32 *val, PRInt32 newval);

/*
** FUNCTION: MPR_AtomicAdd
** DESCRIPTION:
...
*/
NSPR_API(PRInt32)   MPR_AtomicAdd(PRInt32 *ptr, PRInt32 val);
...
#define PR_ATOMIC_INCREMENT(val) MPR_AtomicIncrement(val)
#define PR_ATOMIC_DECREMENT(val) MPR_AtomicDecrement(val)
#define PR_ATOMIC_SET(val, newval) MPR_AtomicSet(val, newval)
#define PR_ATOMIC_ADD(ptr, val) MPR_AtomicAdd(ptr, val)
...
*/
NSPR_API(PRStack *) MPR_CreateStack(const char *stack_name);

/*
** FUNCTION: MPR_StackPush
** DESCRIPTION:
...
**    None
*/
NSPR_API(void)          MPR_StackPush(PRStack *stack, PRStackElem *stack_elem);

/*
** FUNCTION: MPR_StackPop
** DESCRIPTION:
...
**    else NULL
*/
NSPR_API(PRStackElem *) MPR_StackPop(PRStack *stack);

/*
** FUNCTION: MPR_DestroyStack
** DESCRIPTION:
**    Destroy the stack
** INPUTS:
**    stack:        pointer to the stack
...
**                  MPR_GetError will return
**                      PR_INVALID_STATE_ERROR - stack is not empty
*/
NSPR_API(PRStatus)      MPR_DestroyStack(PRStack *stack);
