...
**  Note: PR_INTERVAL_NO_TIMEOUT passed as input to MPR_Connect is
...
***********************************************************************/
NSPR_API(PRIntervalTime) MPR_IntervalNow(void);

/***********************************************************************
** FUNCTION:    MPR_TicksPerSecond
** DESCRIPTION:
**  Return the number of ticks per second for MPR_IntervalNow's clock.
...
** ALGORITHM:   N/A
***********************************************************************/
NSPR_API(PRUint32) MPR_TicksPerSecond(void);

/***********************************************************************
** FUNCTION:    MPR_SecondsToInterval
...
** ALGORITHM:   N/A
***********************************************************************/
NSPR_API(PRIntervalTime) MPR_SecondsToInterval(PRUint32 seconds);
NSPR_API(PRIntervalTime) MPR_MillisecondsToInterval(PRUint32 milli);
NSPR_API(PRIntervalTime) MPR_MicrosecondsToInterval(PRUint32 micro);

/***********************************************************************
** FUNCTION:    MPR_IntervalToSeconds
...
** ALGORITHM:   N/A
***********************************************************************/
NSPR_API(PRUint32) MPR_IntervalToSeconds(PRIntervalTime ticks);
NSPR_API(PRUint32) MPR_IntervalToMilliseconds(PRIntervalTime ticks);
NSPR_API(PRUint32) MPR_IntervalToMicroseconds(PRIntervalTime ticks);
