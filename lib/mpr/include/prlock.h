...
**
***********************************************************************/
NSPR_API(PRLock*) MPR_NewLock(void);

/***********************************************************************
** FUNCTION:    MPR_DestroyLock
** DESCRIPTION:
...
** RETURN:      None
***********************************************************************/
NSPR_API(void) MPR_DestroyLock(PRLock *lock);
...
** RETURN:      None
***********************************************************************/
NSPR_API(void) MPR_Lock(PRLock *lock);
...
***********************************************************************/
NSPR_API(PRStatus) MPR_Unlock(PRLock *lock);
...
#define PR_ASSERT_CURRENT_THREAD_OWNS_LOCK(/* PrLock* */ lock) \
    MPR_AssertCurrentThreadOwnsLock(lock)
#else
#define PR_ASSERT_CURRENT_THREAD_OWNS_LOCK(/* PrLock* */ lock)
#endif

/* Don't call this function directly. */
NSPR_API(void) MPR_AssertCurrentThreadOwnsLock(PRLock *lock);
