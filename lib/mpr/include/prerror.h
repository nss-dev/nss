...
*/
NSPR_API(void) MPR_SetError(PRErrorCode errorCode, PRInt32 oserr);
...
** until the next call to MPR_SetError.
*/
NSPR_API(void) MPR_SetErrorText(
    PRIntn textLength, const char *text);

/*
** Return the current threads last set error code.
*/
NSPR_API(PRErrorCode) MPR_GetError(void);
...
*/
NSPR_API(PRInt32) MPR_GetOSError(void);
...
*/
NSPR_API(PRInt32) MPR_GetErrorTextLength(void);
...
** is unaffected.
*/
NSPR_API(PRInt32) MPR_GetErrorText(char *text);
...
**
***********************************************************************/
NSPR_API(const char *) MPR_ErrorToString(PRErrorCode code,
                                        PRLanguageCode language);


/***********************************************************************
** FUNCTION:    MPR_ErrorToName
** DESCRIPTION:
...
**
***********************************************************************/
NSPR_API(const char *) MPR_ErrorToName(PRErrorCode code);


/***********************************************************************
** FUNCTION:    MPR_ErrorLanguages
** DESCRIPTION:
**  Returns the RFC 1766 language tags for the language
**  codes MPR_ErrorToString() supports.  The returned array is valid
...
**
***********************************************************************/
NSPR_API(const char * const *) MPR_ErrorLanguages(void);


/***********************************************************************
** FUNCTION:    MPR_ErrorInstallTable
** DESCRIPTION:
...
**
***********************************************************************/
NSPR_API(PRErrorCode) MPR_ErrorInstallTable(const struct PRErrorTable *table);


/***********************************************************************
** FUNCTION:    MPR_ErrorInstallCallback
** DESCRIPTION:
...
**
***********************************************************************/
NSPR_API(void) MPR_ErrorInstallCallback(const char * const * languages,
