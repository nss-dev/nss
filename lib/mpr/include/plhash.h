...
MPL_NewHashTable(PRUint32 numBuckets, PLHashFunction keyHash,
...
PR_EXTERN(PRIntn)
MPL_CompareValues(const void *v1, const void *v2);
...
/* This can be trivially implemented using MPL_HashTableEnumerateEntries. */
PR_EXTERN(PRIntn)
