...
NSPR_API(PRSem *) MPR_OpenSemaphore(
...
NSPR_API(PRStatus) MPR_WaitSemaphore(PRSem *sem);
...
NSPR_API(PRStatus) MPR_PostSemaphore(PRSem *sem);
...
NSPR_API(PRStatus) MPR_CloseSemaphore(PRSem *sem);
...
NSPR_API(PRStatus) MPR_DeleteSemaphore(const char *name);
