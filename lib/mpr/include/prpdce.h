...
*/
NSPR_API(PRStatus) MPRP_TryLock(PRLock *lock);
...
** operations (see MPRP_NakedWait, MPRP_NakedNotify, MPRP_NakedBroadcast);
*/
NSPR_API(PRCondVar*) MPRP_NewNakedCondVar(void);
...
*/
NSPR_API(void) MPRP_DestroyNakedCondVar(PRCondVar *cvar);
...
*/
NSPR_API(PRStatus) MPRP_NakedWait(
...
** NB: The CV ('cvar') must be one created using PR_NewNakedCondVar.
*/
NSPR_API(PRStatus) MPRP_NakedNotify(PRCondVar *cvar);
...
** NB: The CV ('cvar') must be one created using PR_NewNakedCondVar.
*/
NSPR_API(PRStatus) MPRP_NakedBroadcast(PRCondVar *cvar);
