...
PR_EXTERN(PRUint32)
MPL_strnlen(const char *str, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strcpy(char *dest, const char *src);
...
PR_EXTERN(char *)
MPL_strncpy(char *dest, const char *src, PRUint32 max);
 ...
 *     MPL_strncpyz(buffer, src, sizeof(buffer));
 *
 * and the result will be properly terminated.
 */

PR_EXTERN(char *)
MPL_strncpyz(char *dest, const char *src, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strdup(const char *s);

/*
 * MPL_strfree
 *
 * Free memory allocated by MPL_strdup
 */
...
PR_EXTERN(char *)
MPL_strndup(const char *s, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strcat(char *dst, const char *src);
...
PR_EXTERN(char *)
MPL_strncat(char *dst, const char *src, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strcatn(char *dst, PRUint32 max, const char *src);
...
PR_EXTERN(PRIntn)
MPL_strcmp(const char *a, const char *b);
...
PR_EXTERN(PRIntn)
MPL_strncmp(const char *a, const char *b, PRUint32 max);
...
PR_EXTERN(PRIntn)
MPL_strcasecmp(const char *a, const char *b);
...
PR_EXTERN(PRIntn)
MPL_strncasecmp(const char *a, const char *b, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strchr(const char *s, char c);
...
PR_EXTERN(char *)
MPL_strrchr(const char *s, char c);
...
PR_EXTERN(char *)
MPL_strnchr(const char *s, char c, PRUint32 n);
...
PR_EXTERN(char *)
MPL_strnrchr(const char *s, char c, PRUint32 n);
...
PR_EXTERN(char *)
MPL_strpbrk(const char *s, const char *list);
...
PR_EXTERN(char *)
MPL_strprbrk(const char *s, const char *list);
...
PR_EXTERN(char *)
MPL_strnpbrk(const char *s, const char *list, PRUint32 n);
...
PR_EXTERN(char *)
MPL_strnprbrk(const char *s, const char *list, PRUint32 n);
...
PR_EXTERN(char *)
MPL_strstr(const char *big, const char *little);
...
PR_EXTERN(char *)
MPL_strrstr(const char *big, const char *little);
...
PR_EXTERN(char *)
MPL_strnstr(const char *big, const char *little, PRUint32 n);
...
PR_EXTERN(char *)
MPL_strnrstr(const char *big, const char *little, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strcasestr(const char *big, const char *little);
...
PR_EXTERN(char *)
MPL_strcaserstr(const char *big, const char *little);
...
PR_EXTERN(char *)
MPL_strncasestr(const char *big, const char *little, PRUint32 max);
...
PR_EXTERN(char *)
MPL_strncaserstr(const char *big, const char *little, PRUint32 max);
 ...
 * user-supplied char * pointer in which MPL_strtok_r stores information
 * for it to continue scanning the same string.
 *
 * In the first call to MPL_strtok_r, s1 points to a string and the value
 * of *lasts is ignored.  MPL_strtok_r returns a pointer to the first
 ...
 * call.  MPL_strtok_r returns a pointer to the next token in s1.  When no
 * token remains in s1, MPL_strtok_r returns null.
 */

PR_EXTERN(char *)
MPL_strtok_r(char *s1, const char *s2, char **lasts);
