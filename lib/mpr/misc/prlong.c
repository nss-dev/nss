...
PR_IMPLEMENT(PRInt64) MLL_Zero(void) { return ll_zero; }
PR_IMPLEMENT(PRInt64) MLL_MaxInt(void) { return ll_maxint; }
PR_IMPLEMENT(PRInt64) MLL_MinInt(void) { return ll_minint; }
PR_IMPLEMENT(PRUint64) MLL_MaxUint(void) { return ll_maxuint; }
