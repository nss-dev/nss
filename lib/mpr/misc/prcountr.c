...
static void _PR_CounterInitialize(void) {
  ...
  */
  ...
  counterLock = MPR_NewLock();
  PR_INIT_CLIST(&qNameList);
  lm = MPR_NewLogModule("counters");
...
/*
** MPR_CreateCounter() -- Create a counter
**
**  ValidateArguments
**  Lock
...
MPR_CreateCounter(const char* qName, const char* rName,
...
MPR_DestroyCounter(PRCounterHandle handle) {
  ...
  */
  ...
  MPR_Unlock(counterLock);
  return;
} /*  end MPR_DestroyCounter() */

/*
**
*/
PR_IMPLEMENT(PRCounterHandle)
MPR_GetCounterHandleFromName(const char* qName, const char* rName) {
  ...
  qh = MPR_FindNextCounterQname(NULL);
  while (qh != NULL) {
    rh = MPR_FindNextCounterRname(NULL, qh);
    while (rh != NULL) {
      MPR_GetCounterNameFromHandle(rh, &qn, &rn, &desc);
      if ((strcmp(qName, qn) == 0) && (strcmp(rName, rn) == 0)) {
        rnp = (RName*)rh;
        goto foundIt;
      }
      rh = MPR_FindNextCounterRname(rh, qh);
    }
    qh = MPR_FindNextCounterQname(NULL);
  }
...
foundIt:
  ...
  return (rh);
} /*  end MPR_GetCounterHandleFromName() */

/*
**
*/
PR_IMPLEMENT(void)
MPR_GetCounterNameFromHandle(PRCounterHandle handle, const char** qName,
  ...
  *description = rnp->desc;
  ...
  return;
} /*  end MPR_GetCounterNameFromHandle() */

/*
**
*/
PR_IMPLEMENT(void)
MPR_IncrementCounter(PRCounterHandle handle) {
  MPR_Lock(((RName*)handle)->lock);
  ((RName*)handle)->counter++;
  MPR_Unlock(((RName*)handle)->lock);

  PR_LOG(lm, PR_LOG_DEBUG,
         ("PR_Counter: Increment: %p, %ld", handle, ((RName*)handle)->counter));

  return;
} /*  end MPR_IncrementCounter() */

/*
**
*/
PR_IMPLEMENT(void)
MPR_DecrementCounter(PRCounterHandle handle) {
  MPR_Lock(((RName*)handle)->lock);
  ((RName*)handle)->counter--;
  MPR_Unlock(((RName*)handle)->lock);
  ...
  return;
} /*  end MPR_DecrementCounter()  */

/*
**
*/
PR_IMPLEMENT(void)
MPR_AddToCounter(PRCounterHandle handle, PRUint32 value) {
  MPR_Lock(((RName*)handle)->lock);
  ...
  return;
} /*  end MPR_AddToCounter() */

/*
**
*/
PR_IMPLEMENT(void)
MPR_SubtractFromCounter(PRCounterHandle handle, PRUint32 value) {
  MPR_Lock(((RName*)handle)->lock);
  ((RName*)handle)->counter -= value;
  MPR_Unlock(((RName*)handle)->lock);
  ...
  return;
} /*  end  MPR_SubtractFromCounter() */

/*
**
*/
PR_IMPLEMENT(PRUint32)
MPR_GetCounter(PRCounterHandle handle) {
  PR_LOG(
      lm, PR_LOG_DEBUG,
...
*/
PR_IMPLEMENT(void)
MPR_SetCounter(PRCounterHandle handle, PRUint32 value) {
  ((RName*)handle)->counter = value;
...
*/
PR_IMPLEMENT(PRCounterHandle)
MPR_FindNextCounterQname(PRCounterHandle handle) {
...
} /*  end  MPR_FindNextCounterQname() */

/*
**
*/
PR_IMPLEMENT(PRCounterHandle)
MPR_FindNextCounterRname(PRCounterHandle rhandle, PRCounterHandle qhandle) {
